...
def render_date_range_filter(data: pd.DataFrame) -> Tuple[pd.Timestamp, pd.Timestamp]:
...
def render_complete_filters(data: pd.DataFrame) -> Tuple[pd.DataFrame, Dict]:
    ...
    # Advanced filters
    advanced_filters = render_advanced_filters(filtered_data)
