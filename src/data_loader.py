...
def load_site_info(csv_file, delimiter=","):
    ...
    site_info = site_info.rename(columns={
        ...
        "8. DeviceID: last digits of the serial number (ex: RPiID-100000007ft35sm --> 7ft35sm)": "deviceID",
        "1. Country": "country",
        "Site": "site"
    })
...
def aggregate_file_counts(audio_df):
    ...
    device_counts = audio_df.groupby('device').agg(file_count=('file', 'count')).reset_index()
